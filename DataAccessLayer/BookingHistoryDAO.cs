...
public class BookingHistoryDAO
{
    ...
    public static BookingReservation CreateBooking(BookingDTO bookingDto)
    {
        ...
        foreach (var detailDto in bookingDto.BookingDetails)
        {
            ...
            {
                BookingReservationId = bookingReservation.BookingReservationId, // Use bookingReservation instead of booking.Entity
            ...
            bookingReservation.BookingDetails.Add(detail); // Add to bookingReservation, not booking.Entity
        }
